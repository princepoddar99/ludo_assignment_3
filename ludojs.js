...
check();
/*if((x==6)&&(document.getElementById('turn').innerHTML=="Turn of A"))
{if((document.getElementById('lockerA').innerHTML=="2A")||(document.getElementById('lockerA').innerHTML=="1A"))
daan=1;
}
else if((x==6)&&(document.getElementById('turn').innerHTML=="Turn of B"))
{if((document.getElementById('lockerA').innerHTML=="2A")||(document.getElementById('lockerA').innerHTML=="1A"))
daan=1;
}*/
}
...
document.getElementById("display").innerHTML=" ";
 if(y>28)
      {document.getElementById("display").innerHTML="You need an exact value to land in the end";
       flagA=0;
      }
  if(y==28)
    {document.getElementById("display").innerHTML="one token wins";
     winA++;
...
document.getElementById("lockerA").innerText="2A";
 ...
 else if((document.getElementById("lockerB").innerText=="1B")&&(document.getElementById('roll1').innerText=="6"))
 {flagB=1;
  daan=0;
